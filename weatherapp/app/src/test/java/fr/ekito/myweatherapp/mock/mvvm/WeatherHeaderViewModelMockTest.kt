...
import fr.ekito.myweatherapp.view.weather.WeatherContract
...
class WeatherHeaderViewModelMockTest {
    ...
    private lateinit var viewModel: WeatherContract.ViewModel
    ...
    fun testSearchNewLocationFailed() {
        ...
        Assert.assertEquals(WeatherViewModel.ProceedLocation(location), events[0])
        Assert.assertEquals(WeatherViewModel.ProceedLocationFail(location, error), events[1])
    }
